...
INSERT INTO `favorites` VALUES ('Hodor','Better Call Saul','television'),('RAFernandez','Birdman','movie'),('Viola','Clannad: After Story','animation'),('Hodor','Game of Thrones','television'),('Hodor','Interstellar','movie'),('RAFernandez','Interstellar','movie'),('Hodor','Jesus Christ Superstar','theater'),('RAFernandez','Mass Effect 3','video game'),('Viola','Mass Effect 3','video game'),('Viola','My Teen Romantic Comedy SNAFU','animation');
...
INSERT INTO `review` VALUES ('RAFernandez','Birdman','Exceptional!',0,'movie'),('RAFernandez','Hybrid Theory','A 21th century classic',0,'album'),('RAFernandez','Interstellar','An Austin review',0,'movie'),('Viola','Clannad: After Story','One of the best anime ever released',0,'animation'),('Viola','Interstellar','Here\'s the review',0,'movie');
...
INSERT INTO `work` VALUES ('Assassin\'s Creed Unity','2014',NULL,'video game',0,1,NULL),('Avatar: The Last Airbender','2003',NULL,'animation',1,1,NULL),('BAYBEH BAYBEH','1999',NULL,'music',0,1,'OH BAYBEH BAYBEH'),('Better Call Saul','2015',NULL,'television',19,1,NULL),('Birdman','2014',NULL,'movie',1,1,NULL),('Bodacious Space Pirates','2012','covers/Bodacious Space Pirates.jpg','animation',1,1,NULL),('Boku no Pico','2009',NULL,'animation',0,0,'Most sublime work ever.'),('Breaking Bad','2008',NULL,'television',1,1,NULL),('Clannad: After Story','2008',NULL,'animation',0,1,NULL),('Community','2009',NULL,'television',1,1,NULL),('Crawling','2000',NULL,'music',0,1,NULL),('Death Note','2006',NULL,'animation',1,1,'Some guy gets a notebook. He writes your name; you die. End of story. Also, there\'s this guy called L. He\'s awesome, but he dies in episode 25 and then the show suck supreme balls after that... except for the finale... that was fucking awesome...'),('Eggs','2007',NULL,'movie',0,0,'Scrambled'),('End of the Line','2014',NULL,'animation',0,1,NULL),('Fate/Zero','2011',NULL,'animation',1,1,NULL),('Fullmetal Alchemist: Brotherhood','2009',NULL,'animation',0,1,'ALCHEMY AND SHIT'),('Game of Thrones','2011',NULL,'television',72,1,'Seven families fight for the Iron Throne of Westeros; a force in the North threatens to destroy everything in Westeros; and in the east, the refugee Daenerys Targaryen seeks to reclaim her family\'s throne. Amidst all this chaos, Winter is Coming.'),('Gotham','2014',NULL,'television',0,1,NULL),('House M.D.','2004',NULL,'television',1,1,NULL),('Hybrid Theory','2000',NULL,'album',0,1,NULL),('Hyperdimension Neptunia Re;Birth 2','2014',NULL,'video game',0,0,'CONSOLE WARS AND SHIT'),('In the End','2000',NULL,'music',0,1,NULL),('Interstellar','2014','covers/Interstellar.jpg','movie',7,1,'In a dying Earth, a farmer named Cooper seeks to save the human race by finding another planet through a wormhole by Saturn.'),('Interstelllar','2014',NULL,'movie',0,0,''),('Jesus Christ Superstar','1970','covers/Jesus Christ Superstar.jpg','theater',2,1,NULL),('Kick-Ass','2010',NULL,'comic',1,1,NULL),('Mad Men','2007',NULL,'television',0,1,NULL),('Mass Effect 3','2012','covers/Mass Effect 3.jpg','video game',3,1,NULL),('Metal Gear Solid 4','2008',NULL,'video game',0,1,'Old Snake \"snakes\" around *wink* *wink*.'),('Metal Gear Solid V: The Phantom Pain','2015',NULL,'video game',0,1,NULL),('Mistborn: The Final Empire','2007',NULL,'book',0,1,'A Mistborn rebel, Kelsier, attempts to overthrow an oppressive government led by a godlike persona known as the Lord Ruler.'),('My Teen Romantic Comedy SNAFU','2013',NULL,'animation',1,1,NULL),('Parks and Recreation','2008',NULL,'television',0,1,NULL),('Pokemon AlphaSapphire','2014',NULL,'video game',0,0,'A remake of Pokemon Sapphire.'),('Potato','','covers/Potato.jpg','web content',1,1,NULL),('Puella Magi Madoka Magica','2011',NULL,'animation',1,1,NULL),('Ready Player One','2011',NULL,'book',0,1,NULL),('Save Rock and Roll','2013','covers/Save Rock and Roll.jpg','album',0,1,NULL),('Steins;Gate','2011',NULL,'animation',0,1,NULL),('The Dark Knight','2008',NULL,'movie',0,0,NULL),('The Killing Joke','1988',NULL,'graphic novel',1,1,NULL),('The Shining','1980',NULL,'movie',0,1,'Jack Nicholson goes crazy.							\r\n						'),('The Walking Dead','2009',NULL,'television',0,0,NULL),('The Walking Dead','2013',NULL,'video game',0,0,NULL),('Transformers: Age of Extinction','2014',NULL,'movie',0,1,NULL),('V for Vendetta','1985',NULL,'graphic novel',1,1,NULL),('w4r5dtfyuhirhegwfdqSASDERTYUF3R','1990',NULL,'movie',0,0,'RJXDFFDFDFJLKLKJFDDOXJFJFHBSDRBD'),('Watchmen','1987',NULL,'graphic novel',1,1,NULL),('xtidk','1665',NULL,'movie',0,0,'cgkfj');
...
-- Dump completed on 2015-04-26 16:46:36
